...
import br.surb.com.br.dscommerce.services.employee.EmployeeFindByIdCustomService;
...
public class EmployeeFindByIdCustomResource {
    private final EmployeeFindByIdCustomService employeeFindByIdCustomService;

    public EmployeeFindByIdCustomResource(EmployeeFindByIdCustomService employeeFindByIdCustomService) {
